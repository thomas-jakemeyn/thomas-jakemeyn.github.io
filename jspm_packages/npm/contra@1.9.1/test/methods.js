/* */ 
'use strict';
var contra = typeof contra !== 'undefined' ? contra : require('../contra');
var a = typeof assert !== 'undefined' ? assert : require('assert');
a.falsy = function(value, message) {
  a.equal(false, !!value, message);
};
...
describe('curry()', function() {
  ...
  it('should play well with contra.series', function(done) {
    ...
    contra.series([contra.curry(b, 1), contra.curry(c, ['a'])], d);
  });
});
